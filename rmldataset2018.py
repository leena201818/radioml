...
def sliceX_normalized(from_filename = '/media/GOLD_XYZ_OSC.0001_1024.hdf5',slice_len = 1024,to_filename='/media/XYZ_1024_2m_norm.hdf5'):
    ...
    to_file.close()
#   采样数据，分块随机打乱顺序，保存成文件
def subsample_data_2018_tofile(from_filename="/media/XYZ_1024_2m_norm.hdf5", sample_rate=1/4,to_filename="/media/norm_XYZ_1024_512k.hdf5"):
...
if __name__ == '__main__':
    # subsample_data_2018_tofile(from_filename="/media/GOLD_XYZ_OSC.0001_1024.hdf5", sample_rate=1/2,to_filename="/media/XYZ_1024_1m.hdf5")
